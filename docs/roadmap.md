...
- Ticket `0004`: replaced hover-based remaining-time editing with explicit always-visible controls.
...
- Notification controls:
  - Volume slider and per-sound loudness normalization.
  - Optional mute schedule windows.
